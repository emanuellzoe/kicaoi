    ...
    <main className="bg-black relative w-full">
      ...
      <section className="relative overflow-hidden w-full min-h-screen">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6 pt-40 pb-24">
          ...
          >
            A yield farming game on Celo. Every crop is a real transaction. Every harvest earns real SEED — all on-chain, all yours.
          </motion.p>
      ...
      <div className="relative z-10 bg-black w-full flex flex-col items-center px-6 pb-24 gap-24">
        ...
        <section id="dashboard" className="w-full max-w-2xl scroll-mt-24">
          <div className="text-center mb-10">
            ...
            <p className="text-white/40 text-sm font-body mt-3 max-w-md mx-auto">Track your CELO balance, SEED balance, plots, achievements — everything in one place.</p>
          </div>
          ...
          <div className="liquid-glass rounded-3xl p-6 overflow-hidden relative">
            ...
            <div className="grid grid-cols-3 gap-2 mb-4">
              {[
                ...
                <div key={p.label} className={`rounded-xl p-3 text-center border ${p.ready ? 'bg-green-900/20 border-green-500/30' : 'bg-white/3 border-white/5'}`}>
